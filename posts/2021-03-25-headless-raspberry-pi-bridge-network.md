---
aliases:
- /raspberry pi/2021/03/25/headless-raspberry-pi-bridge-network
categories:
- raspberry pi
date: '2021-03-25'
description: setup headless raspberry pi to bridge wifi (tethering from phone) to
  ethernet (for my home wifi-router)
